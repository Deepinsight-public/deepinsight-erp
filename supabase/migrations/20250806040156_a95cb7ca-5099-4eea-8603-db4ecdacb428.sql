-- Check the current function definition and completely rewrite it to avoid any ambiguity
DROP FUNCTION IF EXISTS public.create_sales_order_with_stock_deduction(jsonb, jsonb[]);
