...
DROP TRIGGER IF EXISTS update_transferorder_updated_at ON "TransferOrder";
CREATE TRIGGER update_transferorder_updated_at
  BEFORE UPDATE ON "TransferOrder"
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_returnorder_updated_at ON "ReturnOrder";
CREATE TRIGGER update_returnorder_updated_at
  BEFORE UPDATE ON "ReturnOrder"
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();
