export type UserRole = "hq_admin" | "warehouse_admin" | "store_manager" | "store_staff" | "store_employee";
...
export const ROLE_DISPLAY_NAMES: Record<UserRole, { en: string; zh: string }> = {
  ...
  store_employee: { en: "Store Employee", zh: "门店员工" }
};
...
export const ROLE_PERMISSIONS = {
  ...
  store_employee: ["view_store", "create_orders", "view_inventory"]
} as const;